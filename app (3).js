  ...
  function openMunicipioModal(r) {
    ...
    document.getElementById("munRepPdfBtn").addEventListener("click", () => {
      ...
      if (!container) {
        ...
        container.style.cssText = "position:absolute;left:0;top:0;width:800px;font-family:Inter,sans-serif;background:#fff;opacity:0;pointer-events:none;z-index:-1;";
