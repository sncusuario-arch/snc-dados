  ...
  function openMunicipioModal(r) {
    ...
    document.getElementById("munRepPdfBtn").addEventListener("click", () => {
      ...
      if (!container) {
        ...
        container.style.cssText = "position:absolute;left:-9999px;top:0;width:800px;font-family:Inter,sans-serif;background:#fff;";
      ...
      const opt = {
        ...
        image: { type: "jpeg", quality: 0.97 },
        html2canvas: { scale: 2, useCORS: true, scrollX: 0, scrollY: 0, backgroundColor: "#ffffff", windowHeight: container.scrollHeight },
        jsPDF: { unit: "mm", format: "a4", orientation: "portrait" },
        pagebreak: { mode: ["css", "legacy"] }
      };
