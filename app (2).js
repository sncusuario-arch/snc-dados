...
(function () {
  ...
  function openMunicipioModal(r) {
    ...
    document.getElementById("munRepPdfBtn").addEventListener("click", () => {
      ...
      // Monta container completo para o PDF
      ...
      // Posiciona visível mas coberto pelo overlay do modal para o html2canvas capturar
      container.style.cssText = "position:fixed;top:0;left:0;width:800px;z-index:-1;font-family:Inter,sans-serif;background:#fff;";

      const bodyHtml = document.getElementById("munRepBody").innerHTML;

      container.innerHTML = `
        <div style="background:#1c1c1e;color:#fff;padding:24px 28px 20px;">
